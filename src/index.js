...
function createStartupProgress(totalSteps) {
  ...
  // Render concise informational startup logs. Avoid in-place TTY updates
  // to prevent stdout/stderr interleaving in environments where other
  // parts of the app write to stdout concurrently.
